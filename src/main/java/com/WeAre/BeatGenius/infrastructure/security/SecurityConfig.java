    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/beats").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/beats/**").permitAll()

                        // Opérations qui nécessitent authentification
                        .requestMatchers(HttpMethod.POST, "/api/v1/beats/**").hasAuthority("ROLE_PRODUCER")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/beats/**").hasAuthority("ROLE_PRODUCER")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/beats/**").hasAuthority("ROLE_PRODUCER")
