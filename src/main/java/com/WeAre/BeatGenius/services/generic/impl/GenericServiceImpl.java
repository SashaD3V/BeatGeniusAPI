...
public abstract class GenericServiceImpl<E extends BaseEntity, D extends BaseDTO, C, U> implements GenericService<E, D, C, U> {
    protected final JpaRepository<E, Long> repository;
    protected final BaseMapper<E, D, C, U> mapper;

    protected GenericServiceImpl(JpaRepository<E, Long> repository, BaseMapper<E, D, C, U> mapper) {
