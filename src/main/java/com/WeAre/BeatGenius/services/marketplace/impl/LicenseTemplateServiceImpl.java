...
public class LicenseTemplateServiceImpl implements LicenseTemplateService {
    ...
    protected static abstract class LicenseTemplate {
    ...
    private class BasicLicenseTemplate extends LicenseTemplate {
        ...
        @Override protected LicenseType getLicenseType() { return LicenseType.BASIC; }
        @Override protected BigDecimal getPrice() { return new BigDecimal("29.99"); }
        @Override protected String getName() { return "Basic License"; }
        @Override protected String getFileFormat() { return "MP3"; }
        @Override protected boolean isTagged() { return true; }
        @Override protected Integer getDistributionLimit() { return 10000; }
        @Override protected String getRights() { return "Non-exclusive rights"; }
        @Override protected String getContractTerms() {
            return """
                - MP3 file only
    ...
    private class PremiumLicenseTemplate extends LicenseTemplate {
        ...
        @Override protected LicenseType getLicenseType() { return LicenseType.PREMIUM; }
        @Override protected BigDecimal getPrice() { return new BigDecimal("99.99"); }
        @Override protected String getName() { return "Premium License"; }
        @Override protected String getFileFormat() { return "WAV + MP3"; }
        @Override protected boolean isTagged() { return false; }
        @Override protected Integer getDistributionLimit() { return 100000; }
        @Override protected String getRights() { return "Non-exclusive premium rights"; }
        @Override protected String getContractTerms() {
            return """
                - WAV + MP3 files
    ...
    private class ExclusiveLicenseTemplate extends LicenseTemplate {
        ...
        @Override protected LicenseType getLicenseType() { return LicenseType.EXCLUSIVE; }
        @Override protected BigDecimal getPrice() { return new BigDecimal("999.99"); }
        @Override protected String getName() { return "Exclusive Rights"; }
        @Override protected String getFileFormat() { return "WAV + MP3 + Trackouts"; }
        @Override protected boolean isTagged() { return false; }
        @Override protected Integer getDistributionLimit() { return null; }
        @Override protected String getRights() { return "Full exclusive rights"; }
        @Override protected String getContractTerms() {
            return """
    ...
    public License createLicenseFromTemplate(LicenseType type, Beat beat) {
        LicenseTemplate template = switch(type) {
