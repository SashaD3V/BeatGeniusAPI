...
public class BeatCreditController extends BaseController<BeatCredit, BeatCreditResponse, CreateBeatCreditRequest, UpdateBeatCreditRequest> {
    ...
    public ResponseEntity<PageResponse<BeatCreditResponse>> getAll(
            ...
            @RequestParam(defaultValue = "createdAt,desc") @Parameter(description = "Format: champ,direction") String sort) {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "Requête invalide - Total des parts > 100%"),
    ...
    public ResponseEntity<List<BeatCreditResponse>> addCredits(
            ...
            @RequestBody List<CreateBeatCreditRequest> requests) {
    ...
    public ResponseEntity<BeatCreditResponse> update(
            ...
            @RequestBody UpdateBeatCreditRequest updateDto) {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "403", description = "Non autorisé - Seul le producteur concerné peut valider"),
            @ApiResponse(responseCode = "404", description = "Crédit non trouvé")
    })
    ...
    public ResponseEntity<List<BeatCreditResponse>> getPendingCredits(
            @PathVariable Long beatId) {
    ...
    public ResponseEntity<List<BeatCreditResponse>> getBeatCredits(
            @PathVariable Long beatId) {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "403", description = "Non autorisé - Seul le propriétaire du beat peut supprimer"),
            @ApiResponse(responseCode = "404", description = "Crédit non trouvé")
    })
